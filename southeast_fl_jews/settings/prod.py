...
# STATICFILES_STORAGE = 'southeast_fl_jews.settings.custom_storages.CachedS3BotoStorage'
...
# DEFAULT_FILE_STORAGE = 'southeast_fl_jews.settings.custom_storages.MediaStorage'
...
COMPRESS_STORAGE = 'southeast_fl_jews.settings.custom_storages.CachedS3BotoStorage'
