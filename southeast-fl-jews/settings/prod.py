...
STATICFILES_DIRS = (
    # os.path.join(BASE_DIR, 'webapp/.tmp'), # grunt serve
    os.path.join(BASE_DIR, 'webapp/dist/client'), #grunt
...
# STATICFILES_STORAGE = 'southeast-fl-jews.settings.custom_storages.CachedS3BotoStorage'
...
# DEFAULT_FILE_STORAGE = 'southeast-fl-jews.settings.custom_storages.MediaStorage'
...
COMPRESS_STORAGE = 'southeast-fl-jews.settings.custom_storages.CachedS3BotoStorage'
